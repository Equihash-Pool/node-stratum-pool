...
var JobManager = module.exports = function JobManager(options) {
    ...
    this.processShare = function (jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName, soln) {
        ...
        var params = options.coin.params;
        var n = params.n;
        var k = params.k;
        var pers = params.pers;
        ...
        if (soln.length !== expectedLength) {
            return shareError([20, 'Error: Incorrect size of solution (' + soln.length + '), expected ' + expectedLength + ' for n=' + n + ', k=' + k]);
        }
